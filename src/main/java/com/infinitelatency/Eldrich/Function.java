...
class Function {
  ...
  final public boolean equals(Object o) {
    if (o instanceof Function) {
      boolean name =
          this.name == null ? ((Function) o).name == null : this.name.equals(((Function) o).name);
      boolean argTypes = this.argTypes == null ? ((Function) o).argTypes == null
          : this.argTypes.equals(((Function) o).argTypes);
